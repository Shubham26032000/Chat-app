...
import com.example.chatapp.Activities.ChatDetailsActivity;
...
public class UserAdapter extends  RecyclerView.Adapter<UserAdapter.ViewHolders>{
    ...
    @Override
    public void onBindViewHolder(@NonNull  UserAdapter.ViewHolders holder, int position) {
                    ...
                    public void onDataChange(@NonNull  DataSnapshot snapshot) {
                        if (snapshot.hasChildren()){
                            for (DataSnapshot snapshot1 : snapshot.getChildren()){
                                ...
                                holder.lastMessageTime.setText(dateFormat.format(new Date(time)));
